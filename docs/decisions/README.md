...
Phase 1 made no final dataset or serving decision. Phase 2 finalized the dataset in [001-dataset-selection.md](001-dataset-selection.md). Serving decisions remain future work. Do not create fake ADR history merely to populate this directory.
